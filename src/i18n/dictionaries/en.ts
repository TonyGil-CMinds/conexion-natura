...
export const en: Dictionary = {
  ...
  registration: {
    ...
    welcome: {
      ...
      shareText: 'Here is the registration for the Natura500 Night: October 5, 2026 in Quito.',
      copied: 'Link copied to clipboard',
      shareFailed: 'Could not share. Copy the link from your browser bar.',
    },
